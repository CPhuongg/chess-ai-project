...
class ChessApp(QApplication):
    def __init__(self, args):
        ...
        palette = QPalette()
        D  = QColor(theme.APP_BG)
        P  = QColor(theme.SURFACE)
        T  = QColor(theme.TEXT)
        DT = QColor(theme.TEXT_DIM)
        B  = QColor(theme.SURFACE_2)
        BT = QColor(theme.TEXT)
        ...
        palette.setColor(QPalette.AlternateBase,   QColor(theme.SURFACE_2))
